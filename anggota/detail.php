...
<div class="member-detail-page">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0 gap-2">
            ...
            <?php if (($_SESSION['role'] ?? '') === 'admin' || $isOwnProfile): ?>
                <a href="edit.php?id=<?php echo (int) $member['id']; ?>" class="btn btn-primary d-flex align-items-center gap-2 py-2 px-3 border-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="row g-4">
        <div class="col-12 col-md-5 col-lg-4">
            <div class="card member-profile-card p-4 text-center h-100">
                    ...
                    <div class="profile-avatar-container" style="cursor: default; pointer-events: none;">
                        <div class="profile-avatar-inner">
                            ...
                            <?php if (!empty($member['foto']) && file_exists($avatarFile)): ?>
                                <img src="<?php echo htmlspecialchars($avatarPath); ?>" alt="Avatar <?php echo htmlspecialchars($member['nama']); ?>" class="profile-avatar-img">
                            <?php else: ?>
        ...
        <div class="col-12 col-md-7 col-lg-8">
            <div class="card member-projects-card border-0 shadow-sm p-4 h-100">
    ...
    <div class="row detail-explanation-row">
        <div class="col-12">
            <div class="card role-info-card border-0 shadow-sm p-4">
                <h5 class="fw-bold text-dark mb-3">💡 Memahami Peran Sistem vs Jabatan Tim</h5>

                <div class="row g-3">
                    <div class="col-12 col-md-6">
                        <div class="p-3 rounded bg-white border-start border-primary border-4 shadow-sm">
                            <h6 class="fw-bold text-primary mb-2">Role Sistem (Hak Akses)</h6>
                            <p class="text-muted small mb-0">
                                Menentukan hak akses dan kontrol fungsionalitas di dalam aplikasi.
                                <strong>Admin</strong> memiliki akses penuh ke Dashboard Global, CRUD Proyek/Anggota/Assignment, Laporan & Log.
                                <strong>Member</strong> memiliki akses terbatas untuk melihat proyek, tugas, dan profil mereka sendiri.
                            </p>
                        </div>
                    </div>

                    <div class="col-12 col-md-6">
                        <div class="p-3 rounded bg-white border-start border-success border-4 shadow-sm">
                            <h6 class="fw-bold text-success mb-2">Jabatan (Peran Tim)</h6>
                            <p class="text-muted small mb-0">
                                Menentukan tanggung jawab profesional atau posisi fungsional anggota dalam tim proyek
                                seperti <em>Project Manager</em>, <em>Developer</em>, <em>QA Tester</em>, <em>UI/UX Designer</em>, dan lainnya.
                                Jabatan ini tidak membatasi hak akses sistem.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-footer border-0 d-flex justify-content-center gap-2 pb-4">
                    ...
                    <button type="button" class="btn btn-primary px-4 py-2 border-0" style="border-radius: 8px;" data-bs-target="#confirmDeleteModal2" data-bs-toggle="modal">Lanjutkan</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <form action="delete_account.php" method="POST" class="m-0">
                    ...
                    <div class="modal-body p-4">
                        <div class="alert alert-danger border-0 small mb-3 p-3" style="background-color: #fef2f2; color: #991b1b; border-radius: 8px;">
                            <strong>Peringatan Keras!</strong> Tindakan ini tidak dapat dibatalkan. Seluruh data penugasan proyek, data profil, dan data login Anda akan dihapus dari sistem.
                        </div>

                        <p class="text-dark small mb-2">
                            Untuk melanjutkan, ketik kata kunci <strong class="text-danger">HAPUS AKUN</strong> pada kolom di bawah ini:
                        </p>
